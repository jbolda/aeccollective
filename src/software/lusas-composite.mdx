...
tags: ["FEA", "Structural Analysis", "Composite Analysis"]
logo: ./lusas.jpg
...
The intuitive Windows user interface gives easy access to the full range of powerful modeling and results processing facilities, together with on-line help.
